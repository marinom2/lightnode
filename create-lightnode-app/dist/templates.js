...
*.log
`;
const SHARED_ENV_EXAMPLE = (network) => `# Funded private key. Testnet works for free (faucet at https://lightfaucet.ai).
...
`;
const NODE_README = (cfg) => `# ${cfg.projectName}
...
`;
const NEXTJS_README = (cfg) => `# ${cfg.projectName}
...
const HONO_README = (cfg) => `# ${cfg.projectName}
...
export function addFilesFor(template, network) {
