...
import { AlertOctagon, ArrowRight, Layers, Server, User2, Wallet2 } from "lucide-react";
...
export default function BuildSdksPage() {
  return (
    <div className="relative mx-auto max-w-5xl px-5 py-10">
      ...
      {/* Batch + Agent are now full SDK sub-pages (/build/sdks/batch and
          /build/sdks/agent), so they live in the link-card grid above
          alongside the others. No need for an inline section anymore. */}
