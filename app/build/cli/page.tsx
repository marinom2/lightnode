...
export const metadata = {
  ...
  description:
    "The lightnode CLI runs from any terminal. Nine read-only commands, eleven add scaffolders (server-paid, user-paid web3, and the worker-operator console), plus wallet, chat, worker preflight + watch, bridge, dao. Try the read-only commands inline here.",
};
