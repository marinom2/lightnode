...
// balance. Memory only - resets on cold-start, which is fine since the faucet
// refills daily anyway. The shared limiter prunes expired entries so a warm
// instance doesn't accumulate stale records.
